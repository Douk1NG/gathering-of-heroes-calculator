    ...
    <Card>
      <CardHeader className="pb-2">
        <div className="flex justify-between items-end">
          <CardTitle className="text-sm uppercase tracking-widest font-black opacity-60">
            {t(translations.journeyProgress.title)}
          </CardTitle>
      ...
      <CardContent className="space-y-6">
        <div className="space-y-2">
          ...
          <div className="flex justify-between text-[10px] uppercase tracking-widest font-black text-neutral-500 px-1">
            <span>{t(translations.journeyProgress.started)}</span>
            <span>
              {Math.round(progress)}
              {t(translations.journeyProgress.complete)}
            </span>
          </div>
        </div>
